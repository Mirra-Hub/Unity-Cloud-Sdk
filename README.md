...
```
https://github.com/Mirra-Hub/Unity-Cloud-Sdk.git?path=/Packages/com.mirrahub.cloud-sdk#v0.2.4
```
...
The `#v0.2.4` at the end of the URL is a release tag. Package Manager resolves it once, writes the
