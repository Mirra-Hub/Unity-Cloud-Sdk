    ...
    public static class ShowcaseModules
    {
        ...
        private static ServiceMeta[] Build()
        {
            ...
            return new[]
            {
                ...
                M("events", "Events", LucideIcon.CalendarClock, "#A855F7",
                    "Timed rules that quietly change economy values while they run.",
                    ServiceCategory.LiveOps, ServiceCaps.Read),
                ...
                M("attribution", "Attribution", LucideIcon.Waypoints, "#8FA7FF",
                    "Where the player came from: the Adjust device id and campaign, recorded on the account.",
                    ServiceCategory.Data, rw),
